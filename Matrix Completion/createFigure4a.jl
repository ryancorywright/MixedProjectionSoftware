...
for ARG in ARGS
    ...
    for iter in 1:1
        ...
        t_NN=@elapsed X_NN=getMatrixNuclearNorm(coords, entries, M, n, numEntriesSampled, mu, true) #imposing constraints as noiseless so we want exact signal recovery
        u,sigma,v,=svd(X_NN)
...
CSV.write("results_basispursuit_varyingp_n50_k1_gamma100onp_withoutexact.csv", results_exact, append=true)
